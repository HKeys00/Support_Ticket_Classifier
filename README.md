...
- [x] Enable monitoring/logging with Azure Application Insights  
...
- [x] Implement Messaging Queues with either RabbitMQ or Azure Bus for background model retraining
